                        ...
                        <div class="dropdown-cart-top-body border-top p-4">
                            ...
                            @if (session('cart'))
                                @foreach (session('cart') as $id => $details)
                                    ...
                                    @endphp
                            <p class="mb-2"><i class="icofont-ui-press text-danger food-item"></i>{{ $details['name'] }} x  {{  $details['quantity']}} <span class="float-right text-secondary">${{ $details['price'] }}</span></p>
