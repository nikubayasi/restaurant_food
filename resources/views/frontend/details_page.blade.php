                                                        ...
                                                        <p class="text-gray time mb-0">
                                                            @if ($bestseller->discount_price == null)
                                                                <a class="btn btn-link btn-sm text-black"
                                                                    href="#">${{ $bestseller->price }}
                                                                </a>
                                                            @else
                                                                $<del>{{ $bestseller->price }}</del>
                                                                <a class="btn btn-link  ml-2 btn-sm text-black"
                                                                    href="#">${{ $bestseller->discount_price }}
                                                                </a>
                                                            @endif
                                ...
                                @foreach ($menus as $menu)
                                    <div class="row">
                                        <h5 class="mb-4 mt-3 col-md-12">{{ $menu->menu_name }} <small
                                                class="h6 text-black-50">{{ $menu->products->count() }}
                                                ITEMS</small></h5>
                                        <div class="col-md-12">
                                            <div class="bg-white rounded border shadow-sm mb-4">
                                                @foreach ($menu->products as $product)
                                                    <div class="menu-list p-3 border-bottom">
                                                        <a class="btn btn-outline-secondary btn-sm mt-1  float-right"
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <p class="text-success fs-5 mb-0">$ {{ $product->price }}
                                                                    <span
                                                                        class="text-gray">{{ $product->size ?? '' }}</span>
                                                                    cm
                                                                </p>
                            ...
                            <div class="tab-pane fade" id="pills-reviews" role="tabpanel"
                                ...
                                <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
                                    ...
                                    <div class="reviews-members pt-4 pb-4">
                                        <div class="media">
                                            <a href="#"><img alt="Generic placeholder image" src="{{ !empty($review->user->photo) ? url('upload/user_images/' . $review->user->photo) : url('upload/no_image.jpg') }}"
                                ...
                                <div class="bg-white rounded shadow-sm p-4 mb-5 rating-review-select-page">
                                    @guest
                                    <p><b>For Add Restaurant Review. You need to login first</b><a href="{{ route("login") }}">Login Here </a></p>
                                    @else
                                    <style>
                                        .star-rating label{
                                            display: inline-flex;
                ...
                <div class="col-md-4">
                    <div class="pb-2">
                        <div
                            ...
                            @if($coupon == NULL)
                            <p class="mb-0">No Coupon is Avaliable</p>
                            @else
                        ...
                        <div class="bg-white rounded shadow-sm mb-2 p-2">
                                ...
                                @foreach (session('cart') as $id => $details)
                                    ...
                                    <div class="gold-members">
                                        ...
                                        <div class="media mb-2">
                                            <div class="mr-2"><img width="50px" height="50px"
                                                    src="{{ asset($details['image']) }}"></i>
                                            </div>
                                            <div class="media-body">
                            ...
                            @endif
                                    ...
                                    <div class="mb-2 bg-white rounded p-2 clearfix">
                                        ...
                                        <p class="mb-1">Coupon Name <span class="float-right text-dark">{{ session()->get('coupon')['coupon_name'] }} ({{ (session()->get('coupon')['discount']) }} %)</span><a type="submit" onclick="couponRemove()"><i class="icofont-ui-delete float-right" style="color:red;"></i></a></p>


                                        <p class="mb-1 text-success">Total Discount <i class="icofont-info-circle"></i>
                                    ...
                                    <div class="mb-2 bg-white rounded p-2 clearfix">
                                        <div class="input-group input-group-sm mb-2">
                                           ...
                                           <div class="input-group-append">
                                              <button class="btn btn-primary" type="button" id="button-addon2" onclick="ApplyCoupon();"><i class="icofont-sale-discount"></i> APPLY</button>
                                           </div>
                                        </div>
                                        @endif
                                    </div>
