                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt=""
                                            height="28"> <span class="logo-txt">NKLearning</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" method="post"
                                        action="{{ route('admin.password_submit') }}">
                                        @csrf
                                        <div class="mb-3">
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> NKLearning . Crafted with <i
                                            class="mdi mdi-heart text-danger"></i> by NKLearning
                                    </p>
                                </div>
                            </div>
                        </div>
